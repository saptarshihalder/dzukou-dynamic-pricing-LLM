...
def optimize_price(
    ...
    respecting category-specific limits on how much prices may rise or drop.
    It returns the price yielding the highest simulated profit within these
    boundaries.
    """
    ...
    high = min(high, current_price * (1 + max_increase))
    if high < low:
        high = low * 1.5
...
# Maximum allowed price increase relative to current price
MAX_INCREASE = {
    "default": 0.30,
    "Sunglasses": 0.30,
    "Bottles": 0.30,
...
# Maximum allowed price decrease relative to current price
MAX_DECREASE = {
    "default": 0.25,
    "Sunglasses": 0.25,
    "Bottles": 0.25,
